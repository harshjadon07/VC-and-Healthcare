...
export default function DedicatedXrayPage() {
  ...
  const [serverUrl, setServerUrl] = useState('https://a8b73a4ba7d3b4910a.gradio.live/');
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border-b-4 border-sand-300 pb-6">
            <div>
              ...
              <p className="text-base text-slate-700 font-extrabold mt-1">
                Upload X-Rays directly to your Gradio Live Website (<code className="font-mono text-forest-900 font-black">https://a8b73a4ba7d3b4910a.gradio.live/</code>).
              </p>
            </div>
          ...
          <div className="bg-white p-5 rounded-3xl border-4 border-sand-300 shadow-sm space-y-3">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2">
              <input
                ...
                placeholder="https://a8b73a4ba7d3b4910a.gradio.live/"
              ...
              <div className="flex space-x-2 shrink-0">
                <button
                  type="button"
                  onClick={() => setServerUrl('https://a8b73a4ba7d3b4910a.gradio.live/')}
